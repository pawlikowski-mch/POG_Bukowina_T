...
map.getView().fit([2244428.233888, 6337426.829555, 2244889.614200, 6337686.910875], map.getSize());
...
map.getView().on('change:resolution', function(evt){
            ...
            lyr_GRANICA_GMINY_4.setStyle(style_GRANICA_GMINY_4);
});
